...
<p>&nbsp;<img class="" src="http://www.jummum.co/Android/AND_JUMMUM_OM/jummumOMLogo.png" alt="" width="120" /></p>
...
<?php
    ...
    if($_POST["submit"])
    {
        ...
        else
        {
            ...
            {
                header("Location: http://www.jummum.co/Android/AND_JUMMUM_OM/ResetPasswordTimeOut.php");
